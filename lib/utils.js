...
import { utilsConfig } from "../config.js";
...
export default class Utils {
	...
	constructor(client) {
		...
		this.tellAllToTell = utilsConfig.tellAllToTell;

		// 启动轮询
		if (utilsConfig.enablePolling) {
			this.startPolling();
		}
	...
	onMessage(data) {
		...
		// 调试记录信息
		shared.logger.debug(`Client -> Server ${JSON.stringify(data)}`);
