...
const routes = [
	...
	{ path: "/mods", name: "mods", component: () => import("../views/Mods.vue"), meta: { title: "模组", icon: "mods" } },
	...
	{ path: "/update", name: "update", component: () => import("../views/Update.vue"), meta: { title: "更新", icon: "update" } },
